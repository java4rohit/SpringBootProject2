package com.java4rohit.email_sending;
...
public class App 
{
    public static void main( String[] args )
    {
        ...
        String message="Hello , dear , this is message for security chck";
        String subject="CodeArea: Confimation";
        String to="java4rohit@gmail.com";
    ...
    //this is responsible to send the message with attachment
         private static void sendAttach(String message, String subject, String to, String from) {
        	//variable for gmail
     		...
     		try {
     			...
     			String path="C:\\Users\\java4rohit\\Desktop\\img.jpg";
		...
		///this method is responsible to send mail
