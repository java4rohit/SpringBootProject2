...
public class GenerateKeywordIdeas {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (!params.parseArguments(args)) {
      ...
      params.locationIds =
          Arrays.asList(
              ...
              Long.parseLong("21167"));
      params.languageId = Long.parseLong("1000");
      params.keywords = Arrays.asList("wool ball");
	...
	properties.put("api.googleads.clientId", "156278677098-1ep919703i0ehoc13o3a12qh7r7d9fk7.apps.googleusercontent.com");
	properties.put("api.googleads.clientSecret", "uK8ljo7CqIBF2F8UlzrXcFlB");
	properties.put("api.googleads.developerToken","tUdJR_OwGlfZ-33ESFdB0Q");
	properties.put("api.googleads.refreshToken","1//04cg36gsxPXgxCgYIARAAGAQSNwF-L9IrpE9KbJ3WgIRBR0EHGnQLoRoadOlOkTvfhhQyyx_7yyI1QC9xpfgAEH8t34UG6lwuyoU");
